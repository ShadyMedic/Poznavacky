...
/**
 * Třída obsahující vlastnosti a metody pro různé chybové, varovné, informativní či úspěchové hlášky zobrazované
 * uživateli
 * @author Jan Štěch
 */
class MessageBox
{
    ...
    private const CSS_CLASSES = array(
        0 => 'success-message',
        1 => 'info-message',
        2 => 'warning-message',
        3 => 'error-message'
     ...
     * @return string[] Asociativní pole se dvěma indexy - 'message' a 'messageClass' s obsahem hlášky, respektive CSS
     *     třídou pro zobrazení na stránce
     */

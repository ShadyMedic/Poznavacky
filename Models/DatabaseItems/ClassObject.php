...
class ClassObject extends Folder
{
     ...
     * (čili uživatelé, kteří mají záznam v tabulce "uzivatele_tridy" v důsledku pozvání nebo zadání vstupního kódu).
    ...
    /**
     * Metoda odstraňující uživatele ze třídy (odstraňuje spojení uživatele a třídy z tabulky "uzivatele_tridy")

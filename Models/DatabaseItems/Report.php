...
class Report extends DatabaseItem implements DisplayableInReportsTable
{
    ...
    const ALL_REASONS = array(
        self::REASON_NOT_DISPLAYING,
        self::REASON_LONG_LOADING,
        self::REASON_INCORRECT_NATURAL,
        self::REASON_CONTAINS_NAME,
        self::REASON_BAD_RESOLUTION,
        self::REASON_COPYRIGHT,
        self::REASON_OTHER,
        self::REASON_OTHER_ADMIN
    );
     ...
     */
    public function initialize($picture = null, $reason = null, $additionalInformation = null,
                               $reportersCount = null): void
    {
        ...
        if ($reportersCount === null) {
            $reportersCount = $this->reportersCount;
        }
    ...
    public function getAdditionalInformation(): string
    {
        ...
        if (gettype($this->additionalInformation) === 'NULL') {
            return '';
        }

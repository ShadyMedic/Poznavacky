...
class NewClassRequester
{
    ...
    private function validate($email, string $name, $code, $text, $antispam)
    {
        ...
        if (!strlen((int)$code) === 4){throw new AccessDeniedException(AccessDeniedException::REASON_NEW_CLASS_REQUEST_INVALID_CODE, null, null, array('originFile' => 'NewClassRequester.php', 'displayOnView' => 'requestNewClass.phtml'));}

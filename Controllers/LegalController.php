...
class LegalController extends SynchronousController
{
    ...
    function process(array $parameters): void
    {
        ...
        self::$pageHeader['cssFiles'] = array();
        self::$pageHeader['jsFiles'] = array();
        self::$pageHeader['bodyId'] = 'legal';

        $githubFetcher = new GitHubFileFetcher();
        try { self::$data['staticContent'][0] = $githubFetcher->getTermsOfService(); }
        catch (UnexpectedValueException $e) { self::$data['staticContent'][0] = $e->getMessage(); }
        try { self::$data['staticContent'][1] = $githubFetcher->getPrivacyPolicy(); }

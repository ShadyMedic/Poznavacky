...
<html>
    ...
    <body>
		<?php    
			...
			{
				echo "<span id='wrongAdminPassword'>Zadali jste špatné heslo nebo nemáte pozici admina</span>";
			}
			if (!isset($_POST['adminPassword']) || !password_verify(@$_POST['adminPassword'], $adminHash))
			{
				echo "
					<form id='adminCheck' action='management.php' method=POST>
						<input type=password maxlength=31 placeholder='Zadejte heslo' name='adminPassword'>

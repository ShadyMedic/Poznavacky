...
function confirmNameChange()
{
	...
	postRequest("php/ajax/changeUsername.php", responseFunc, responseFunc, newName);
...
function changePasswordVerify()
{
	...
	postRequest("php/ajax/checkPassword.php", changePasswordStage2, responseFunc, null, password);
}
...
function confirmPasswordChange()
{
	...
	postRequest("php/ajax/changePassword.php", responseFunc, responseFunc, null, oldPass, newPass, rePass);
...
function changeEmailVerify()
{
	...
	postRequest("php/ajax/checkPassword.php", changeEmailStage2, responseFunc, null, password);
}
...
function deleteAccountVerify()
{
	...
	postRequest("php/ajax/checkPassword.php", deleteAccountConfirm, responseFunc, null, password);
}
...
function deleteAccountFinal()
{
	...
	postRequest("php/ajax/deleteAccount.php", responseFunc, null, username, pass);
}

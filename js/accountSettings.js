...
function changeNameCancel()
{
    ...
    $("#change-name").closest(".user-property.data-item").find(".user-property.value").show();
    $("#change-name").hide();
...
function changePasswordCancel()
{
    ...
    $("#change-password").closest(".user-property.data-item").find(".user-property.value").show();
...
function changeName()
{
    ...
    $("#change-name").closest(".user-property.data-item").find(".user-property.value").hide();
    $("#change-name").show();
...
function changePassword()
{
    ...
    $("#change-password").closest(".user-property.data-item").find(".user-property.value").hide();
...
function changeEmail(action)
{
    if (action == 'remove')
    {
        ...
        $("#change-email h3").text("Odebrání e-mailu");
    }
    else
    {
        $("#change-email h3").text("Změna e-mailu");
    }
    $("#change-email-button").hide();
    $("#remove-email-button").hide();
    $("#change-email").closest(".user-property.data-item").find(".user-property.value").hide();
    $("#change-email").show();

<?php
    function tryCookieLogin()
    {
        ...
        if (mysqli_num_rows($result) > 0)
        {
            ...
            $query = "SELECT uzivatele_id,jmeno,heslo,email,posledni_changelog,vzhled,pridane_obrazky,uhodnute_obrazky,karma,status FROM uzivatele WHERE uzivatele_id = $userId LIMIT 1";
            $result = mysqli_query($connection, $query);
